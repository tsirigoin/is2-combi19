...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado', models.CharField(choices=[('viajando', 'Viajando'), ('finalizado', 'Finalizado'), ('reservado', 'Reservado')], max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('temperatura', models.DecimalField(decimal_places=1, default=None, max_digits=2, validators=[django.core.validators.MinValueValidator(0)])),
            ],
        ),
        migrations.CreateModel(
            name='Viaje',
