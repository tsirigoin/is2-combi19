...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado', models.CharField(choices=[('viajando', 'Viajando'), ('finalizado', 'Finalizado'), ('cancelado', 'Cancelado'), ('perdido', 'Perdido'), ('reservado', 'Reservado')], default='reservado', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('viajando', 'Viajando'), ('reservado', 'Reservado'), ('cancelado', 'Cancelado'), ('finalizado', 'Finalizado')], default='reservado', max_length=12)),
            ],
        ),
    ]
