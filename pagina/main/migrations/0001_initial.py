# Generated by Django 3.2 on 2021-06-30 23:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado', models.CharField(choices=[('viajando', 'Viajando'), ('cancelado', 'Cancelado'), ('perdido', 'Perdido'), ('reservado', 'Reservado'), ('finalizado', 'Finalizado')], default='reservado', max_length=12)),
