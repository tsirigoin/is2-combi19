# Generated by Django 3.2 on 2021-07-01 01:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado', models.CharField(choices=[('cancelado', 'Cancelado'), ('perdido', 'Perdido'), ('reservado', 'Reservado'), ('viajando', 'Viajando'), ('finalizado', 'Finalizado')], default='reservado', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('viajando', 'Viajando'), ('cancelado', 'Cancelado'), ('finalizado', 'Finalizado'), ('reservado', 'Reservado')], default='reservado', max_length=12)),
            ],
        ),
    ]
