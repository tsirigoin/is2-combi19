# Generated by Django 3.2 on 2021-06-30 21:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado', models.CharField(choices=[('viajando', 'Viajando'), ('reservado', 'Reservado'), ('finalizado', 'Finalizado'), ('perdido', 'Perdido'), ('cancelado', 'Cancelado')], default='reservado', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('viajando', 'Viajando'), ('finalizado', 'Finalizado'), ('reservado', 'Reservado'), ('cancelado', 'Cancelado')], default='reservado', max_length=12)),
            ],
        ),
    ]
