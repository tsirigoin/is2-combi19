...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estado', models.CharField(choices=[('reservado', 'Reservado'), ('perdido', 'Perdido'), ('cancelado', 'Cancelado'), ('finalizado', 'Finalizado'), ('viajando', 'Viajando')], default='reservado', max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('descripcion', models.CharField(max_length=100)),
                ('fecha', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2021, 6, 30))])),
                ...
                ('estado', models.CharField(choices=[('cancelado', 'Cancelado'), ('viajando', 'Viajando'), ('finalizado', 'Finalizado'), ('reservado', 'Reservado')], default='reservado', max_length=12)),
            ],
        ),
    ]
