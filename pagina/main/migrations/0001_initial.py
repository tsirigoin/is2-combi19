    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
<<<<<<< Updated upstream
                ('estado', models.CharField(choices=[('finalizado', 'Finalizado'), ('perdido', 'Perdido'), ('reservado', 'Reservado'), ('viajando', 'Viajando'), ('cancelado', 'Cancelado')], default='reservado', max_length=12)),
=======
                ('estado', models.CharField(choices=[('reservado', 'Reservado'), ('perdido', 'Perdido'), ('viajando', 'Viajando'), ('cancelado', 'Cancelado'), ('finalizado', 'Finalizado')], default='reservado', max_length=12)),
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
                ('estado', models.CharField(choices=[('finalizado', 'Finalizado'), ('reservado', 'Reservado'), ('viajando', 'Viajando'), ('cancelado', 'Cancelado')], default='reservado', max_length=12)),
=======
                ('estado', models.CharField(choices=[('reservado', 'Reservado'), ('finalizado', 'Finalizado'), ('cancelado', 'Cancelado'), ('viajando', 'Viajando')], default='reservado', max_length=12)),
>>>>>>> Stashed changes
            ],
        ),
    ]
