...
class Insumo(models.Model):
    ...
    cantidadActual = models.IntegerField(validators=[MinValueValidator(0), MaxValueValidator(999)])
    cantidadTotal = models.IntegerField(validators=[MinValueValidator(0), MaxValueValidator(999)])
    def __str__(self):
        return (self.nombre)
...
class Pasajero(models.Model):
    ...
    insumos = models.TextField(blank=True)
